...
entity approximate_tan_inve_mask_table1_rom is 
    generic(
             DWIDTH     : integer := 23; 
             AWIDTH     : integer := 5; 
             MEM_SIZE    : integer := 32
...
architecture rtl of approximate_tan_inve_mask_table1_rom is 
...
entity approximate_tan_inve_mask_table1 is
    generic (
...
architecture arch of approximate_tan_inve_mask_table1 is
    component approximate_tan_inve_mask_table1_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    approximate_tan_inve_mask_table1_rom_U :  component approximate_tan_inve_mask_table1_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
